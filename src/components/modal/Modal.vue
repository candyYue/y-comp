          ...
          <div class="modal-content" v-drag="draggable" v-show="visible">
              ...
              <div class="modal-footer"  v-if="showFooter">
                  ...
                  <slot name="footer" v-else>
                      ...
                      <el-button type="primary" size="medium" v-if="showComfirm" @click="comfirm" :disabled="comfirmBtnDisabled || (loading || saveLoading)" :class="{'loading-btn':loading || saveLoading}">
